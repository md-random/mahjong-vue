...
- **Interactive Settings Hub**: A central modal allowing players to curate their active music rotation playlist (featuring auto-extracted video thumbnails), adjust SFX volume, and view game options.
